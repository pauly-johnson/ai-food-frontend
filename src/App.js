    ...
    <div className="container">
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <fieldset className="checkbox-group preferences-group">
          <legend>
            Optional: Choose preferences such as dietary needs or health goals
          </legend>
            ...
            {otherList.map((item) => (
              <label key={item} className="other-chip">
                ...
                <button
                  ...
                  onClick={() => handleRemoveOther(item)}
                >
                  &times;
                </button>
              </label>
        ...
        <div className="serves-row">
          <label htmlFor="serves-input" className="serves-label">
            Number of Serves:
          </label>
          <input
            id="serves-input"
        ...
        <div className="selected-summary">
          ...
          <ul>
            ...
            <li>
              Vegetable:{" "}
              {vegetables.length ? vegetables.join(", ") : <em>None</em>}
            </li>
            <li>Carb: {carbs.length ? carbs.join(", ") : <em>None</em>}</li>
            <li>Side: {sides.length ? sides.join(", ") : <em>None</em>}</li>
            <li>
              Other: {otherList.length ? otherList.join(", ") : <em>None</em>}
            </li>
            <li>Serves: {serves}</li>
            <li>
              Preferences:{" "}
              {preferences.length ? preferences.join(", ") : <em>None</em>}
            </li>
      ...
      {recipe && (
        <div className="recipe">
          <h2>{recipe.name}</h2>
          <p>
            <strong>Estimated Cooking Time:</strong> {recipe.cookingTime}
          </p>
          <h3>Ingredients:</h3>
          <ul>
